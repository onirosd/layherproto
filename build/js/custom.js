...
function  init_calendar() {
	...
	categoryClass;
     ...
     var CONFIG = (function() {
     var private = {
         'ELEMENTS': ['month','customWeek','agendaDay','listDay'],
    ...
    $('#calendar').fullCalendar({
      ...
      header: {
        ...
        center: 'title',
        right:  CONFIG.get('ELEMENTS')[0]+","+CONFIG.get('ELEMENTS')[1]+","+CONFIG.get('ELEMENTS')[2]+","+CONFIG.get('ELEMENTS')[3]
      },
        defaultView: CONFIG.get('ELEMENTS')[1],
        views: {
          customWeek: {
          type: 'timeline',
          duration: { weeks: 1 },
      ...
      eventRender: function(event, element, view) {
	    ...
	    // element.css('background-color', '#FFB347');
         ...
         // }
		   ...
		   var nhora =  '<nav class="fc-time">'+crono+'</nav>';
